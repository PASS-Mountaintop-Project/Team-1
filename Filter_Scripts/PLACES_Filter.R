...
places_ce_2020 <- read.csv("./Raw_Data/PLACES_Files/PLACES__Local_Data_for_Better_Health__County_Data_2021_release.csv")

places_co_2021 <- read.csv("./Raw_Data/PLACES_Files/PLACES__Local_Data_for_Better_Health__County_Data_2021_release.csv")
places_co_2020 <- read.csv("./Raw_Data/PLACES_Files/PLACES__Local_Data_for_Better_Health__County_Data_2021_release.csv")
